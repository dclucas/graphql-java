...
public interface GraphqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GraphqlParser#serviceDefinition}.
	 * @param ctx the parse tree
	 */
	void enterServiceDefinition(GraphqlParser.ServiceDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphqlParser#serviceDefinition}.
	 * @param ctx the parse tree
	 */
	void exitServiceDefinition(GraphqlParser.ServiceDefinitionContext ctx);
	/**
	 * Enter a parse tree produced by {@link GraphqlParser#serviceUrl}.
	 * @param ctx the parse tree
	 */
	void enterServiceUrl(GraphqlParser.ServiceUrlContext ctx);
	/**
	 * Exit a parse tree produced by {@link GraphqlParser#serviceUrl}.
	 * @param ctx the parse tree
	 */
	void exitServiceUrl(GraphqlParser.ServiceUrlContext ctx);
	/**
