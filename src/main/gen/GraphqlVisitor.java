...
public interface GraphqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GraphqlParser#serviceDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitServiceDefinition(GraphqlParser.ServiceDefinitionContext ctx);
	/**
	 * Visit a parse tree produced by {@link GraphqlParser#serviceUrl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
